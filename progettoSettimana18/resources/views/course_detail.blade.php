                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if ($user && $user->is_admin == 0)
                        <form method="post" action="{{ route('reservations.store') }}" enctype="multipart/form-data"
                            ...
                            <button type="submit" class="btn btn-outline-success mt-4 w-100">Conferma
                                iscrizione</button>
                        </form>
                    @endif
                    <a type="button" class="btn btn-outline-dark mt-4 w-100" href="/courses">Torna ai corsi</a>
                    <a type="button" class="btn btn-outline-warning my-2 w-100" href="/reservations">Guarda tutte le
                        prenotazioni</a>
                </div>
            </div>
        </div>
