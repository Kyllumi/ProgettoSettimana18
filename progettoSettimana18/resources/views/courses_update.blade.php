            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 text-center">
                    <form method="post" action="{{ route('courses.update', $course->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="d-flex gap-3">
                            <div class="mb-3 w-50">
                                ...
                                <select class="form-select" name="start_time" required>
                                    <option value="{{ $course->start_time }}">{{ $course->start_time }} (attuale)
                                    </option>
                        ...
                        <button type="submit" class="btn btn-outline-dark my-2 w-100"
                            onsubmit="return confirm('Sei sicuro di voler modificare questo corso?')">Modifica
                            corso</button>
                    </form>
                </div>
            </div>
